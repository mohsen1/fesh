...
| `bzip2` | 76.9KB | 34.3KB (45%) | 30.1KB (39%) | 31.9KB (42%) | 28.9KB (38%) | **27.8KB (36%)** | **-1.1KB (3.9%)** |
| `chrony` | 242.7KB | 125.3KB (52%) | 109.2KB (45%) | 114.4KB (47%) | 100.9KB (42%) | **95.9KB (40%)** | **-5.1KB (5.0%)** |
| `clang` | 28.51MB | 10.01MB (35%) | 6.84MB (24%) | 7.27MB (26%) | 6.13MB (22%) | **5.73MB (20%)** | **-410.4KB (6.5%)** |
| `cmake` | 9.53MB | 4.03MB (42%) | 2.87MB (30%) | 3.06MB (32%) | 2.47MB (26%) | **2.36MB (25%)** | **-112.0KB (4.4%)** |
| `coreutils` | 1.09MB | 537.1KB (48%) | 450.4KB (40%) | 473.4KB (42%) | 416.4KB (37%) | **387.9KB (35%)** | **-28.5KB (6.8%)** |
| `cpio` | 133.4KB | 63.5KB (48%) | 55.0KB (41%) | 58.1KB (44%) | 51.9KB (39%) | **49.8KB (37%)** | **-2.2KB (4.2%)** |
| `ctags` | 1.23MB | 493.0KB (39%) | 408.8KB (32%) | 433.0KB (34%) | 356.2KB (28%) | **329.9KB (26%)** | **-26.4KB (7.4%)** |
| `curl` | 266.0KB | 150.1KB (56%) | 135.8KB (51%) | 140.9KB (53%) | 132.4KB (50%) | **128.9KB (48%)** | **-3.4KB (2.6%)** |
| `diffutils` | 178.1KB | 91.4KB (51%) | 80.9KB (45%) | 84.8KB (48%) | 76.9KB (43%) | **74.6KB (42%)** | **-2.2KB (2.9%)** |
...
| `ethtool` | 479.3KB | 168.0KB (35%) | 136.6KB (28%) | 145.7KB (30%) | 125.2KB (26%) | **117.1KB (24%)** | **-8.1KB (6.4%)** |
| `expat` | 141.7KB | 57.0KB (40%) | 48.6KB (34%) | 51.6KB (36%) | 46.8KB (33%) | **46.0KB (32%)** | **-808B (1.7%)** |
| `ffmpeg` | 278.1KB | 119.1KB (43%) | 101.5KB (36%) | 107.2KB (38%) | 96.3KB (35%) | **89.5KB (32%)** | **-6.8KB (7.1%)** |
| `findutils` | 251.3KB | 125.7KB (50%) | 110.3KB (44%) | 115.7KB (46%) | 103.6KB (41%) | **100.0KB (40%)** | **-3.5KB (3.4%)** |
| `fish` | 1.47MB | 590.8KB (39%) | 474.6KB (32%) | 500.0KB (33%) | 427.5KB (28%) | **410.5KB (27%)** | **-16.9KB (4.0%)** |
...
| `gawk` | 466.0KB | 236.3KB (51%) | 204.6KB (44%) | 214.4KB (46%) | 188.3KB (40%) | **172.6KB (37%)** | **-15.7KB (8.4%)** |
| `gcc` | 22.49MB | 8.40MB (37%) | 6.42MB (28%) | 6.83MB (30%) | 5.62MB (25%) | **5.20MB (23%)** | **-427.1KB (7.4%)** |
| `ghostscript` | 22.47MB | 4.77MB (21%) | 3.91MB (17%) | 4.08MB (18%) | 3.58MB (16%) | **3.41MB (15%)** | **-172.8KB (4.7%)** |
| `git` | 2.73MB | 1.35MB (49%) | 1.13MB (41%) | 1.18MB (43%) | 1.03MB (38%) | **994.6KB (36%)** | **-63.7KB (6.0%)** |
| `gmp` | 405.8KB | 213.8KB (53%) | 187.8KB (46%) | 195.8KB (48%) | 178.2KB (44%) | **175.8KB (43%)** | **-2.3KB (1.3%)** |
...
| `gzip` | 74.9KB | 37.0KB (49%) | 32.7KB (44%) | 34.2KB (46%) | 31.2KB (42%) | **28.9KB (38%)** | **-2.3KB (7.5%)** |
...
| `iputils` | 62.6KB | 29.2KB (47%) | 25.6KB (41%) | 27.5KB (44%) | 24.1KB (38%) | **24.0KB (38%)** | **-84B (0.3%)** |
...
| `kmod` | 138.2KB | 63.0KB (46%) | 54.9KB (40%) | 57.9KB (42%) | 50.9KB (37%) | **49.6KB (36%)** | **-1.3KB (2.5%)** |
...
| `libxml2` | 1.16MB | 530.7KB (45%) | 438.6KB (37%) | 463.0KB (39%) | 406.3KB (34%) | **384.6KB (32%)** | **-21.6KB (5.3%)** |
...
| `llvm12` | 27.04MB | 10.39MB (38%) | 7.65MB (28%) | 8.09MB (30%) | 7.09MB (26%) | **6.74MB (25%)** | **-360.1KB (5.0%)** |
| `lsof` | 147.3KB | 71.1KB (48%) | 61.7KB (42%) | 64.9KB (44%) | 57.3KB (39%) | **51.9KB (35%)** | **-5.4KB (9.4%)** |
| `lua5.3` | 121.9KB | 59.3KB (49%) | 52.4KB (43%) | 55.2KB (45%) | 48.9KB (40%) | **48.6KB (40%)** | **-312B (0.6%)** |
| `lz4` | 253.9KB | 118.2KB (46%) | 96.7KB (38%) | 103.1KB (41%) | 91.7KB (36%) | **87.7KB (35%)** | **-3.9KB (4.3%)** |
...
| `mariadb` | 20.12MB | 6.39MB (32%) | 4.65MB (23%) | 4.95MB (25%) | 4.29MB (21%) | **3.99MB (20%)** | **-310.1KB (7.1%)** |
| `memcached` | 212.2KB | 104.4KB (49%) | 90.2KB (42%) | 95.3KB (45%) | 84.6KB (40%) | **79.7KB (38%)** | **-4.9KB (5.8%)** |
| `mosquitto` | 238.1KB | 110.1KB (46%) | 92.1KB (39%) | 97.5KB (41%) | 85.0KB (36%) | **81.3KB (34%)** | **-3.7KB (4.3%)** |
| `mpc` | 74.0KB | 26.7KB (36%) | 21.8KB (30%) | 23.5KB (32%) | 20.5KB (28%) | **19.8KB (27%)** | **-765B (3.6%)** |
| `mpv` | 1.97MB | 822.7KB (41%) | 700.6KB (35%) | 728.8KB (36%) | 650.9KB (32%) | **628.2KB (31%)** | **-22.7KB (3.5%)** |
| `mtr` | 67.7KB | 28.8KB (43%) | 24.7KB (36%) | 26.4KB (39%) | 22.9KB (34%) | **22.3KB (33%)** | **-609B (2.6%)** |
...
| `ncurses` | 73.9KB | 31.1KB (42%) | 26.9KB (36%) | 28.7KB (39%) | 25.7KB (35%) | **25.1KB (34%)** | **-596B (2.3%)** |
...
| `nodejs` | 39.92MB | 14.52MB (36%) | 10.76MB (27%) | 11.42MB (29%) | 9.93MB (25%) | **9.60MB (24%)** | **-338.6KB (3.3%)** |
| `openssh` | 322.0KB | 131.8KB (41%) | 113.2KB (35%) | 118.5KB (37%) | 102.5KB (32%) | **101.5KB (32%)** | **-1.0KB (1.0%)** |
| `openssl` | 647.0KB | 257.3KB (40%) | 213.8KB (33%) | 223.9KB (35%) | 194.4KB (30%) | **177.8KB (28%)** | **-16.5KB (8.5%)** |
...
| `perl` | 3.16MB | 1021.8KB (32%) | 772.8KB (24%) | 816.0KB (25%) | 713.6KB (22%) | **675.4KB (21%)** | **-38.2KB (5.3%)** |
| `php8` | 8.01MB | 1.86MB (23%) | 1.43MB (18%) | 1.52MB (19%) | 1.33MB (17%) | **1.25MB (16%)** | **-81.1KB (6.0%)** |
| `procps` | 118.2KB | 42.5KB (36%) | 34.4KB (29%) | 36.9KB (31%) | 32.0KB (27%) | **29.6KB (25%)** | **-2.5KB (7.7%)** |
| `python3` | 2.70MB | 1.09MB (40%) | 909.3KB (33%) | 964.1KB (35%) | 823.4KB (30%) | **767.9KB (28%)** | **-55.5KB (6.7%)** |
| `readline` | 286.8KB | 116.7KB (41%) | 98.8KB (34%) | 103.1KB (36%) | 93.0KB (32%) | **85.8KB (30%)** | **-7.3KB (7.8%)** |
...
| `stunnel` | 176.1KB | 77.5KB (44%) | 65.4KB (37%) | 69.1KB (39%) | 60.1KB (34%) | **57.2KB (32%)** | **-2.9KB (4.9%)** |
| `sysstat` | 406.0KB | 147.4KB (36%) | 119.5KB (29%) | 127.5KB (31%) | 110.6KB (27%) | **100.4KB (25%)** | **-10.1KB (9.2%)** |
...
| `tree` | 87.8KB | 29.7KB (34%) | 23.9KB (27%) | 25.7KB (29%) | 21.6KB (25%) | **19.4KB (22%)** | **-2.2KB (10.3%)** |
| `tshark` | 263.8KB | 108.3KB (41%) | 90.6KB (34%) | 95.7KB (36%) | 83.5KB (32%) | **79.2KB (30%)** | **-4.2KB (5.1%)** |
| `unzip` | 181.9KB | 82.9KB (46%) | 71.7KB (39%) | 76.0KB (42%) | 69.1KB (38%) | **60.6KB (33%)** | **-8.5KB (12.3%)** |
| `vim` | 2.70MB | 1.36MB (50%) | 1.16MB (43%) | 1.21MB (45%) | 1.06MB (39%) | **991.7KB (36%)** | **-93.6KB (8.6%)** |
| `wget` | 463.1KB | 223.6KB (48%) | 190.6KB (41%) | 202.3KB (44%) | 177.9KB (38%) | **169.4KB (37%)** | **-8.4KB (4.7%)** |
| `x264` | 2.27MB | 955.9KB (41%) | 646.3KB (28%) | 691.0KB (30%) | 626.6KB (27%) | **608.2KB (26%)** | **-18.5KB (2.9%)** |
| `x265` | 153.9KB | 52.7KB (34%) | 43.8KB (28%) | 46.6KB (30%) | 42.0KB (27%) | **39.9KB (26%)** | **-2.0KB (4.8%)** |
| `xz-libs` | 133.7KB | 70.7KB (53%) | 64.1KB (48%) | 66.6KB (50%) | 62.0KB (46%) | **61.8KB (46%)** | **-206B (0.3%)** |
| `xz` | 70.1KB | 29.2KB (42%) | 25.1KB (36%) | 26.7KB (38%) | 23.8KB (34%) | **23.3KB (33%)** | **-584B (2.4%)** |
| `zip` | 178.9KB | 81.6KB (46%) | 70.2KB (39%) | 73.7KB (41%) | 65.6KB (37%) | **58.9KB (33%)** | **-6.7KB (10.3%)** |
| `zlib` | 97.9KB | 50.6KB (52%) | 45.2KB (46%) | 47.2KB (48%) | 44.1KB (45%) | **44.1KB (45%)** | **-27B (0.1%)** |
| `zsh` | 637.6KB | 325.3KB (51%) | 281.2KB (44%) | 292.7KB (46%) | 261.4KB (41%) | **235.4KB (37%)** | **-25.9KB (9.9%)** |
| `zstd-libs` | 1.05MB | 452.2KB (42%) | 357.1KB (33%) | 380.4KB (35%) | 343.5KB (32%) | **333.9KB (31%)** | **-9.6KB (2.8%)** |
| `zstd` | 1.30MB | 545.7KB (41%) | 433.9KB (33%) | 460.4KB (35%) | 411.8KB (31%) | **368.1KB (28%)** | **-43.6KB (10.6%)** |
